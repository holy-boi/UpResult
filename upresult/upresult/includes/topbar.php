            	...
            	<div class="container-fluid">
                    <div class="row">
                        <div class="navbar-header no-padding">
                			<a class="navbar-brand" target="a_blank" href="https://holyboiz.000webhostapp.com/me/index.html">
                		...
                		<div class="collapse navbar-collapse" id="navbar-collapse-1">
                			<ul class="nav navbar-nav" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                ...
                                <li style="color: red;"><marquee behavior="scroll" scrollamount="3"><strong>  Just for experimental purpose!</strong></marquee></li>
                			</ul>
                            <!-- /.nav navbar-nav -->
