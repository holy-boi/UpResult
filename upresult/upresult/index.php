            ...
            <div class="item">
              <div class=" banner-view banner-top1 d-flex align-items-center justify-content-center text-center">
                <div class="banner-info-bg">
                  ...
                  <p class="mt-md-4 mt-3">OURSCHOOL RESULT CHECKING SITE FOR GRADE 6</p>
             ...
             <div class="item">
              <div class=" banner-view banner-top2 d-flex align-items-center justify-content-center text-center">
                <div class="banner-info-bg">
                  ...
                  <p class="mt-md-4 mt-3">BE CONVERED ALL ROUND EVEN IN "IT"</p>
                  <a class="btn btn-style btn-danger mt-sm-5 mt-4 mr-2" href=""> Learn More</a>
                </div>
              </div>
            </div>
          ...
          <div class="container py-5">
            <div class="row footer-top-29">
              <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-1 pr-lg-5">
                ...
                <p>Holyboi, a rising developer based in biafran west africa. </p>
              ...
              <div class="col-lg-2 col-md-6 col-sm-5 col-6 footer-list-29 footer-2 mt-sm-0 mt-5">
                ...
                <ul>
                  ...
                  <li><a href="https://dchamps.000webhostapp.com/OurTeam/team.html">About Our Team</a></li>
              ...
              <div class="col-lg-2 col-md-6 col-sm-5 col-6 footer-list-29 footer-3 mt-lg-0 mt-5">
                <h6 class="footer-title-29">other blogs</h6>
                <ul>
                  <li><a href="https://dchamps.000webhostapp.com/west-africa/burkinafaso/index.html">west-africa</a></li>
                  <li><a href="https://dchamps.000webhostapp.com/OurTeam/team.html">Our team</a></li>
                  <li><a href="#">e-cart</a></li>
                  <li><a href="https://holiwebz.000webhostapp.com/updatedStore/index.php">e-commerce</a></li>
                  <li><a href="https://holyboiz.000webhostapp.com/video_blog/index.html">video-catalog</a></li>
                </ul>

              </div>
              <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-4 mt-lg-0 mt-5">
                <h6 class="footer-title-29">Contact Info </h6>
                <p>Address : No 12 MTN rd.Umuocheala OSISIOMA-NGWA L.G.A. Aba,Abia state,Nigeria</p>
                <p class="mt-2">Phone : <a href="tel:(+234) 9162316194">(+234)9162316194</a></p>
                <p class="mt-2">Email : <a href="mailto:emeriebow78@gmail.com">emeriebow78@gmail.com</a></p>
                <p class="mt-2">Support : <a href="mailto:emeriebow78@gmail.com">emeriebow78@gmail.com</a></p>
              </div>
            </div>
          </div>
        <!-- copyright -->
