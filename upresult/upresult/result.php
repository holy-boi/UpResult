...
$query = "SELECT tblstudents.StudentName, tblstudents.RollId, SUM(tblresult.marks) as total_marks
          FROM tblstudents
          LEFT JOIN tblresult ON tblstudents.StudentId = tblresult.StudentId
          GROUP BY tblstudents.StudentId";
$query = $dbh->prepare($query);
$query->execute();
$student_totals = $query->fetchAll(PDO::FETCH_OBJ);
...
$first_student = $student_totals[0];
$second_student = $student_totals[1];
$third_student = $student_totals[2];

// Display congratulatory messages for the top three students
echo "<p>Congratulations to $first_student->StudentName for achieving the highest total marks: $first_student->total_marks out of $outof!</p>";
echo "<p>Well done to $second_student->StudentName for the second highest total marks: $second_student->total_marks out of $outof!</p>";
echo "<p>Great job to $third_student->StudentName for the third highest total marks: $third_student->total_marks out of $outof!</p>";
